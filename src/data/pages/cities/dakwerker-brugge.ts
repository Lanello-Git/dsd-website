...
const content: CityContent = {
  ...
  faq: [
    ...
    { q: 'Wat doet u bij stormschade aan mijn dak in Brugge?', a: 'Wij komen eerst het dak afdekken zodat het binnen droog blijft, bel daarvoor 0460 23 15 34. Door de ligging vlak bij de kust krijgt Brugge veel westerwind te verwerken: verschoven pannen, losse nokpannen en afgewaaide dakranden zijn de meest voorkomende schade. Wij leggen alles vast op foto, u krijgt een offerte voor uw verzekeraar en daarna herstellen wij definitief en zetten wij de pannen met extra klemmen vast.' },
