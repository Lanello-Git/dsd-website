...
const content: CityContent = {
  ...
  faq: [
    ...
    { q: 'Mijn dak in Nevele of Vinkt heeft stormschade, wat doe ik nu?', a: 'Bel ons zo snel mogelijk op 0478 67 25 82, zodat wij het dak voorlopig kunnen afdekken en de losse pannen terugleggen. Rond Nevele, Vinkt en Hansbeke liggen de hoeves en fermettes in open veld, en daar zijn het bij een westerstorm vooral nokpannen, dakranden en schouwafwerkingen die het begeven. U krijgt van ons foto\'s van de schade en een offerte die u aan uw verzekeraar kunt voorleggen, waarna wij definitief herstellen.' },
